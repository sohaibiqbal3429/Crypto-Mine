  ...
  return [
    {
      ...
      referredBy: null,
      isActive: true,
      first_qualifying_deposit_at: now,
      first_qualifying_deposit_amount: 1200,
      emailVerified: true,
      phoneVerified: true,
      depositTotal: 1200,
      withdrawTotal: 300,
    ...
    },
    {
      ...
      isActive: true,
      first_qualifying_deposit_at: now,
      first_qualifying_deposit_amount: 600,
      emailVerified: true,
      phoneVerified: false,
      depositTotal: 600,
      withdrawTotal: 100,
    ...
    },
    {
      ...
      isActive: true,
      first_qualifying_deposit_at: now,
      first_qualifying_deposit_amount: 350,
      emailVerified: false,
      phoneVerified: true,
      depositTotal: 350,
      withdrawTotal: 50,
    ...
    },
    {
      ...
      isActive: true,
      first_qualifying_deposit_at: now,
      first_qualifying_deposit_amount: 420,
      emailVerified: true,
      phoneVerified: true,
      depositTotal: 420,
      withdrawTotal: 0,
